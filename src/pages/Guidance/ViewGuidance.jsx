...
const ViewGuidance = () => {
          ...
          if (response.data.secondary_feeling_id) {
            try {
              const secondaryResponse = await getById(
                ...
                response.data.secondary_feeling_id?._id,
                false
              );
  ...
  const { title, description, profile_photo, createdAt } = guidanceData;
  ...
  const data = [
    ...
    {
      key: "Primary Feeling",
      value: guidanceData.primary_feeling_id?.name || "N/A",
    },
    {
      key: "Secondary Feeling",
      value: guidanceData.secondary_feeling_id?.name || "N/A",
    },
